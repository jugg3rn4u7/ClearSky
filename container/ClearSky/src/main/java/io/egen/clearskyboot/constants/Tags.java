...
public final class Tags {
	...
	public static final String FIND_ALL_READINGS_DESC = "Returns a JSON array of all weather readings";
	...
	public static final String FIND_DISTINCT_CITIES_DESC = "Returns a JSON array consisting of a unique list of cities from all readings";
